...
class PPOAgent:
    ...
    def get_stacked_observation(self, obs):
        ...
        # 如果是第一幀 (Buffer 是空的)，將同一幀複製 4 次填滿
        ...
        # 堆疊 frames: (64, 64, 1) * 4 -> (64, 64, 4)
        stacked_obs = np.concatenate(list(self.frame_buffer), axis=2)

        # 轉換為 Channel-First 給 PyTorch 模型: (4, 64, 64)
    ...
    def act(self, observation):
        ...
        # 3. 增加 Batch 維度 (SB3 需要 Batch Size) -> (1, 4, 64, 64)
        # 這樣就符合 ValueError 要求的 (n_env, 4, 64, 64) 格式了
...
if __name__ == '__main__':
    ...
    # 預設模型路徑
    parser.add_argument('--model', type=str, default='./logs/PPO_circle_cw_Standard_baseline/final_model')
